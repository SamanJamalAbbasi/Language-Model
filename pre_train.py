...
def train(input_file, target, word_dict):
    with tf.Session() as sess:
        ...
        summary_writer = tf.summary.FileWriter("Language_Model", sess.graph)
        # Checkpoint
        ...
        def train_step(batch_inputs):
            ...
            _, step, summaries, loss, logits = sess.run([train_op, global_step, summary_op, model.loss, model.logits],
                                                        feed_dict=feed_dict)
